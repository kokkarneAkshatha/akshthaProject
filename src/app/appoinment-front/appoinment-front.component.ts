...
export class AppoinmentFrontComponent implements OnInit {

  isSubmitted = false;
branch1:Branch[];
spcl:Specialist[];
  // City Names
  City: any = ['hebbal','Nagawara']
  Spl: any = ['Accident and Emergency', 'dental',
   'Anaesthesia & Intensive Care', 'Blood Bank','Cardiology' , 'Cardiothoracic & Vascular Surgery', 'Dental Department','Dermatology', 'ENT Department', 'Ophthalmolo ','Gynaecology & Obst.',  'Neurology' , 'Orthopaedics' , 'Paediatrics', 'Physiotherap', 'Psychiatry', 'Radiology']
